...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cantones y caseríos</li>
      </ol>
    </section>
	<!-- Main content -->
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h1 class="box-title">Cantones y caseríos 
							<?php
								if(isset($_SESSION['121AGR40']) && $_SESSION['121AGR40']==1){ ?>
									<button id="btnagregar" class="btn btn-success" onclick="mostrarform(true)" data-toggle="tooltip" data-placement="top" title="Agregar Cantones y caseríos"><i class="fa fa-plus-circle"></i>  Agregar</button></h1>
							<?php } ?>
						</h1>
					    ...
					    <span id="leyenda">(*) Campos obligatorios</span><br>
							<form name="formulario" id="formulario" method="POST">
								<div class="form-group col-lg-9 col-md-12 col-sm-12 col-xs-12">
									<label>Nombre Cantón/caserío(*):</label>
									<input type="hidden" id="idcantoncaserio" name="idcantoncaserio">
									<input type="text" class="form-control" id="nombrecantoncaserio" name="nombrecantoncaserio" maxlength="150" placeholder="Nombre del cantón o del caserío" required>
								</div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/cantonesycaserios.js" ></script>
<?php
}
ob_end_flush();
?>