...
ob_start();
session_start();
//Verifica que esté en actividad o inactividad
...
//Verifica si ha iniciado sesión con su usuario
					...
					<div class="panel-body table-reponsive"  id="listadoregistros">
						<div class="row">
							...
							<div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-6">
								...
								<select id="departamento" name="departamento" class="form-control selectpicker" data-live-search="true">
								</select>									
							</div>
							<div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-6">
							...
							<form id="formulario" method="POST">
								...
								<div id="datospersonales" style="padding-top: 20px;"> <!-- DATOS PERSONALES -->
									...
									<div class="form-group col-lg-3 col-md-3 col-sm-4 col-xs-12">
										...
										<option value="O">Otro</option>	<!--Se agregó opción otro-->														
										</select>								
									</div>
