...
if(isset($_SESSION['014TIP']) && $_SESSION['014TIP']==1){
?>
<!--CONTENIDO-->
...
<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Tipo de Actividad</li>
      </ol>
    </section>
	<!-- Main content -->
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
						<h1 class="box-title">Tipo actividad 
							<?php
								if(isset($_SESSION['015AGR14']) && $_SESSION['015AGR14']==1){ ?>
					...
					<div class="panel-body" style="height: 400px;" id="formularioregistros">
                        ...
                        <form name="formulario" id="formulario" method="POST">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <input type="hidden" id="idtipoactividad" name="idtipoactividad">
                                <input type="text" class="form-control" id="nombretac" name="nombretac" maxlength="40" placeholder="Tipo Actividad" required>
                            </div>
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/tipoactividad.js" ></script>
<?php
}
ob_end_flush();
?>