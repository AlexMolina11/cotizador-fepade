...
function init() {
 ...
 //Cargamos los items al select tipo participante
    $.post("../ajax/repParticipantes.php?op=selectTipoParticipante", function(r) {
        $("#tipoparticipante").html(r);
        $("#tipoparticipante").selectpicker('refresh');
    });	
	
	 $.post("../ajax/repParticipantes.php?op=selectMunicipio", function(r) {
        $("#municipio").html(r);
        $("#municipio").selectpicker('refresh');
    });	
	
	 $.post("../ajax/repParticipantes.php?op=selectCorredor", function(r) {
        $("#corredor").html(r);
...
function listar() {
    ...
    tabla = $("#tblreporte").dataTable({
        ...
        "ajax":{
                url:'../ajax/repParticipantes.php?op=listar',
                type:"get",
                //data:datos,
                data:{fechaini:fechaini,fechafin:fechafin,tipoparticipante:tipoparticipante,municipio:municipio,corredor:corredor},
                dataType:"json",
                error:function(e){
