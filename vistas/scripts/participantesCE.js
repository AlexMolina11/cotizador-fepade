...
function init(){
    ...
    $("#iddepartamento").change(function(){
        ...
        if(iddepartamento == 0) {
            $.post("../ajax/participantes.php?op=selectMunicipio", function(r) {
                $("#idmunicipio").html(r);
            ...
            $.post("../ajax/comunidad.php?op=selectMuni",{iddepartamento:iddepartamento},function(r) {             
                $("#idmunicipio").html(r);
                $("#idmunicipio").selectpicker('refresh');
            });
    ...
    $("#corredorpar").change(function() {
        var corredorpar = $("#corredorpar").val();
        console.log("el nuevo corredor es:" +corredorpar);
        if(corredorpar == ""){
            ...
            $.post("../ajax/participantes.php?op=selectInstituciones",{corredorpar:corredorpar}, function(r) {
                $("#idinstitucion").html(r);
                $("#idinstitucion").selectpicker('refresh');
            });
        }
...
function limpiar(){  
    ...
    $("#iddiscapacidad").selectpicker('refresh');
    $("#iddepartamento").val("0"); //Se agregó el departamento
...
function ver(idparticipante) {
    ...
    $.post(
        ...
        function(data, status) {
            ...
            $("#iddepartamento").selectpicker('refresh'); //Se agegó departamento
            ...
            $("#idcomunidad").selectpicker('refresh');		
            $("#corredorpar").val(data.IDCORREDOR);
            $("#corredorpar").selectpicker('refresh');		
            ...
            $("#iddepartamento").prop("disabled", true); //Se agregó departamento
...
function regresarform() {
    ...
    $("#iddepartamento").prop("disabled", false);	//Se agregó departamento
...
function mostrar(idparticipante){
    $.post("../ajax/participantes.php?op=mostrar",{idparticipante:idparticipante},function(data,status){
        ...
        /*$.post("../ajax/participantes.php?op=selectDepartamento_mostrar",{iddepartamento:iddepartamento},function(r) {
            $("#iddepartamento").html(r);
            $("#iddepartamento").selectpicker('refresh');
        });*/
        ...
        $.post("../ajax/participantes.php?op=selectCorredor_mostrar",{iddepartamento:iddepartamento, corredorpar:corredorpar},function(r) {             
            $("#corredorpar").html(r);
            $("#corredorpar").selectpicker('refresh');
        });

        $.post("../ajax/participantes.php?op=selectCentroEducativo_mostrar",{corredorpar:corredorpar, idinstitucion:idinstitucion},function(r) {             
            $("#idinstitucion").html(r);
            $("#idinstitucion").selectpicker('refresh');
        });
	});
