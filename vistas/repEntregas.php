...
<div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reporte de Entregas</li>
      </ol>
    </section>
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border">
                          <h1 class="box-title">Reporte de Entregas</h1>
					...
					<div class="panel-body table-reponsive"  id="listadoregistros">
					       <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <label>Categoria Materiales:</label>                                         
									<select id="catproduto" name="catproduto" class="form-control selectpicker" data-live-search="true" required>
								    </select>                                           
                             </div>													
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/repEntregas.js"></script>
<?php
}
ob_end_flush();
?>