...
<div class="content-wrapper">
	...
	<section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Reporte de Asistencias</li>
      </ol>
    </section>
					...
					<div class="panel-body table-reponsive"  id="listadoregistros">
					       <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
							...
							<div class="input-group-addon">
                                ...
                                <input type="date" class="form-control pull-right" id="fechaini" name="fechaini" value="<?php echo date("Y-m-d");?>"/>
                            </div>
                            </div>
						     <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
							<div class="input-group date">
							...
							<div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
									...
									<select id="tipoactividad" name="tipoactividad" class="form-control selectpicker" data-live-search="true">
								    </select>                                           
                             </div>	
							 <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                    <label>Actividades:</label>                                         
									<select id="actividades" name="actividades" class="form-control selectpicker" data-live-search="true">
								    </select>                                           
                             </div>
...
require 'footer.php';
?>
<script type="text/javascript" src="scripts/repAsistencias.js"></script>
<?php
}
ob_end_flush();
?>